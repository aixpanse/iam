        ...
        try {
            ...
            const res = await fetch("/api/signup", {
                ...
                body: JSON.stringify({
                    ...
                    domain: redirectUrl ? new URL(redirectUrl).hostname : undefined,
                }),
            });
    ...
    if (success) {
        return (
            <div className="flex flex-col items-center gap-2 text-center">
                ...
                <Button variant="link" className="w-full" onClick={() => redirect(redirectUrl ? `/signin?redirectUrl=${redirectUrl}` : '/signin')}>
                    Sign in
                </Button>
            </div>
        );
