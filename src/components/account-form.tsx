...
export function AccountForm({
    ...
    return (
        <div>
            <Form {...userForm}>
                <form onSubmit={userForm.handleSubmit(onSubmitUser)} className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <Form {...deleteForm}>
                <form onSubmit={deleteForm.handleSubmit(onSubmitDelete)} className={cn("flex flex-col gap-6", className)} {...props}>
